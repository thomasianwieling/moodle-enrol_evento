...
$string['addtogrouping'] = 'Add new group to grouping';
$string['addtogroup_help'] = 'Adding the participant from this enrolment methode to an existing or a new group.';
$string['addtogrouping_help'] = 'Adding the new group to an existing or a new grouping.';
$string['creategroup'] = 'Create new group';
$string['creategrouping'] = 'Create new grouping';
...
$string['newgroupingname'] = 'New grouping:';
