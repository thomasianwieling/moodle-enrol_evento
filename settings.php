...
if ($ADMIN->fulltree) {
    ...
    $settings->add(
        new admin_setting_configtext(
            ...
            '21300, 21310, 21330, 21350, 21352, 21355, 21380', PARAM_TEXT, 100
        )
    );
